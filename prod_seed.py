...
def seed_prod_db():
    try:
        with get_connection() as db_connection:
            ...
            with open('./db/data/prod_data/ads.json', 'r') as json_file:
                ad_test_data = json.load(json_file)

            with open('./db/data/prod_data/blogs.json', 'r') as json_file:
                blog_test_data = json.load(json_file)

            with open('./db/data/prod_data/comments.json', 'r') as json_file:
                comment_test_data = json.load(json_file)

            with open('./db/data/prod_data/activities.json', 'r') as json_file:
